...
A plot of the momentum sphere with trajectories from each initial condition can be found in \ref{fig:momentum_sphere}.
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{momentum_sphere.png}
    \label{fig:momentum_sphere}
    \caption{Angular momentum sphere with example trajectories for initial angular velocity along each principal axis.}
\end{figure}
\end{document}